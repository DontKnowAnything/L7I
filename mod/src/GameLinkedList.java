/**
 * Maintains ordered linked list of Nodes and throws error message for invalid
 * Node
 *
...
public class GameLinkedList implements GameLinkedListInterface {
   ...
   @Override
   public void removeLowest() {// Beginning VS End : Depends on ascending or
   							// descending?
   	// TODO Auto-generated method stub
   ...
   public void add(String newName, int newScore ) throws LinkedListException {
      ...
      if (newScore >= 0 && (!(newName.equals("")))) {
         if (isEmpty()) {// List may be empty
            ...
            if (head.getScore() > newNode.getScore()) {// Node belongs at
            											// beginning, change
            											// to < and
               Node current = head;
               ...
               while (current.getNext() != null
               		&& current.getNext().getScore() < newNode
               				.getScore()) {// to > for highest to lowest
